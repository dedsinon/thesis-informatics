                    ...
                    <div class="card" id="table">
                        ...
                        <div class="container-fluid">
                            <table class="table table-hover table-striped table-bordered">
                                ...
                                <?php 
                                    $sql ="SELECT * FROM useraccount ORDER BY user_firstname ASC";
                                ...
                                <tbody>
                                    ...
                                    <?php if($row['user_status'] == "1") { ?>
                                        ...
                                        <td style="text-align: center;"><button type="submit" class="btn btn-success btn-sm btn-fill" data-toggle="modal" data-target="#myModalEdit<?php echo $row['user_id'];?>"> Edit </button></td>
                                        <td style="text-align: center;"><button type="button" class="btn btn-danger btn-sm btn-fill" id="<?php echo $row['user_id']; ?>" onclick="window.location.href='server/useraccount.php?status=0&userid=<?php echo $row['user_id'] ?>'">Deactivate</button></td>

                                    <?php $count++ ; } else { ?>
                                    
                                        <td style="background-color: #FF4A55;"><?php echo $count ;?></td>
                                        <td style="background-color: #FF4A55;"><?php echo $row['user_firstname']." ".$row['user_lastname'];?></td>
                                        <td style="background-color: #FF4A55;"><?php echo $row['user_department'];?></td>
                                        <td style="background-color: #FF4A55;"><?php echo $row['user_position'];?></td>
                                        <td style="background-color: #FF4A55;"><?php echo $row['user_name'];?></td>
                                        <td style="background-color: #FF4A55;"><?php echo $row['user_email'];?></td>
                                        <td style="background-color: #FF4A55;"><button type="submit" class="btn btn-success btn-sm btn-fill" data-toggle="modal" data-target="#myModalEdit<?php echo $row['user_id'];?>" disabled> Edit </button></td>
                                        <td style="text-align: center; background-color: #FF4A55;"><button type="button" class="btn btn-primary btn-sm btn-fill" id="<?php echo $row['user_id']; ?>" onclick="window.location.href='server/useraccount.php?status=1&userid=<?php echo $row['user_id'] ?>'"> Activate</button></td>
                                    </tr>
                                </tbody>
                                <?php $count++ ; } } ?>
                            </table>
...
<div id="myModalAdd" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    ...
    <form action="server/useraccount.php" method="POST" autocomplete="on">
...
<div id="myModalEdit<?php echo $row['user_id'];?>" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    ...
    <div class="modal-content">
      ...
      <form method="POST" action="server/useraccount.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="department" placeholder="Department" type="text" required>
                                            <option value="<?php echo $row['user_department'];?>"><?php echo $row['user_department'];?></small></option>
                                                <?php
                                                    $department = array('Faculty Department', 'Services Department', 'Administrative Department', 'Student Council Department');
                                                        for($i=0; $i < 4; $i++){
                                                            if ($row['user_department'] != $department[$i]) {

                                                                echo '<option>'. $department[$i] .'</option>';
                                                            } 
                                                        }                                                
                                                ?>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="position" placeholder="Department" type="text" required>
                                            <option value="<?php echo $row['user_position'];?>"><?php echo $row['user_position'];?></small></option>
                                                <?php
                                                    $position = array('Head Officer', 'Assistant Officer');
                                                        for($i=0; $i < 2; $i++){
                                                            if ($row['user_position'] != $position[$i]) {
