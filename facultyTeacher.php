                                ...
                                <tbody>
                                    ...
                                    <?php if($row['user_status'] == "1") { ?>
                                        ...
                                        <td style="text-align: center;">
                                            <?php if($row['user_status'] != "1") { ?>
                                                <button type="button" class="btn btn-primary btn-sm btn-fill" id="<?php echo $row['user_id']; ?>" onclick="window.location.href='server/activate_useraccount.php?status=1&userid=<?php echo $row['user_id'] ?>'"> Activate</button>                        
                                            <?php } else { ?>
                                                <button type="button" class="btn btn-danger btn-sm btn-fill" id="<?php echo $row['user_id']; ?>" onclick="window.location.href='server/activate_useraccount.php?status=0&userid=<?php echo $row['user_id'] ?>'">Deactivate</button>
                                            <?php } ?>
                                        </td>

                                    <?php } else { ?>
                                        <td style="background-color: #FF4A55;"><?php echo $row['user_id'];?></td>
